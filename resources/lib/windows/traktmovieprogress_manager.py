			...
			if action in self.selection_actions:
				...
				if focus_id == 2050: # listItems
					...
					for item in self.item_list:
						...
						self.selected_items.append(item.getProperty('kingpin.imdb'))
		...
		def builder():
			for count, item in enumerate(self.results, 1):
				try:
					...
					listitem.setProperty('kingpin.poster', item.get('poster', ''))
					listitem.setProperty('kingpin.clearlogo', item.get('clearlogo', ''))
